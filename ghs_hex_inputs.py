...
def present_input_selections(metric_selector, repo_aggregated: bool, repo_topic_aggregated: bool, start_date: datetime.date, multiselect_contributors, multiselect_repo_names, multiselect_repo_topics) -> dict:
    default_metric_selector: list = [
        "prs_per_day", "avg_pr_duration", "avg_code_movement_per_pr"]
    dict_inputs: dict = {
    ...
    print(
        f"Creating Hex plot output using the following metrics: {dict_inputs['metric_selector']}")
...
gdict_inputs: dict = present_input_selections(metric_selector, repo_aggregated, repo_topic_aggregated,
                                              start_date, multiselect_contributors, multiselect_repo_names, multiselect_repo_topics)
